...
if not isRDR then
  ...
  RegisterCommand('toggleChat', function()
    isFirstHide = false
    --print(chatHideState) --2 eltünve, 0 csak ha aktív, 1 látható mindig
    lib.registerContext({
      id = 'chat_menu',
      ...
      options = {
        {
          title = 'Eltüntetés',
          description = 'A chat eltűnik és nem jön elő többet!',
          onSelect = function()
            chatHideState = 2
        ...
        {
          title = 'Csak ha aktív',
          description = 'A chat csak akkor jön elő ha aktív!',
          onSelect = function()
            chatHideState = 0
            SetResourceKvp('hideState', tostring(chatHideState))
          end,
        ...
        {
          title = 'Mindig látható',
          description = 'A chat cak folyamatosan ott lesz és nem tűnik el!',
          onSelect = function()
            chatHideState = 1
            SetResourceKvp('hideState', tostring(chatHideState))
          end,
